...
namespace EEM.Common.Adapters
{
  public class PollingService
  {
    ...
    public PollingService(TimeService timeService)
    {
    ...
    public JsonRequest GetFirstPollRequest(City city, string sessionId)
    {
      ...
      requestitems.Add("VIS", String.Format("c:{0}:0:-874:-412:1196:1016", city.Id));
      ...
      JsonRequest json = Poll.Request(sessionId, 1, requestitems);

      return json;
    }

    public JsonRequest GetPollRequest(City city, string sessionId, int requestCount)
    {
      JsonRequest json = Poll.Request(sessionId, requestCount, PollRequestItems);
      return json;
    }
  }
}
