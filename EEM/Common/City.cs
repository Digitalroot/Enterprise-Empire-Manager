...
namespace EEM.Common
{
  public class City : ICity
  {
    ...
    public List<IMilitaryGrouping> Units { get; set; }
    ...
    public void Update(ICityResponseToBeFixed cityResponseToBeFixed)
    {
    ...
    public void Update(IGetPublicCityInfoResponse cityInfoResponse)
    {
    ...
    public void Update(IPollResponse cityResponseToBeFixedsource)
    {
      var cityResponseToBeFixed = (CityResponse)cityResponseToBeFixedsource;
